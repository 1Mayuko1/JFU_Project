    ...
    return (
        <section>
            ...
            <div className="w-full flex justify-center">
                <div className="w-[90%] md:w-[80%] lg:w-[80%] semiLgXl:w-full flex semiLgXl:flex-row flex-col items-center justify-center">

                    <div className="flex sm:flex-row flex-col w-full justify-center sm:justify-evenly">
                        <div className="semiLgXl:max-h-[770px] semiLgXl:min-h-[770px] w-[90%] sm:w-[40%] bg-gray-100 shadow-2xl rounded-lg my-5 mx-5">
                        ...
                        <div className="semiLgXl:max-h-[600px] semiLgXl:min-h-[600px] w-[90%] sm:w-[40%] bg-gray-100 shadow-2xl rounded-lg my-5 mx-5">
                    ...
                    <div className="flex sm:flex-row flex-col w-full justify-evenly">
                        <div className="semiLgXl:max-h-[600px] semiLgXl:min-h-[600px] w-[90%] sm:w-[40%] bg-gray-100 shadow-2xl rounded-lg my-5 mx-5">
                ...
                {/*            <div className="border-2 border-[#616161] rounded-xl bg-gray-100 flex flex-row justify-center items-center">*/}
                ...
                {/*                    <input type="text" name="search" className="w-full h-[50px] justify-center items-center placeholder-gray-600 text-sm text-gray-700 bg-gray-100 rounded-xl pl-3 focus:outline-none focus:text-gray-700" placeholder="Search some text" value={searchTerm} onChange={handleChange}/>*/}
                {/*                </div>*/}
                {/*            </div>*/}
                {/*        </form>*/}
                {/*    </div>*/}
